        ...
        <div className="text-amber-900 rounded-2xl  w-80">
          ...
          <div className="flex flex-col font-playfair mb-2">
            ...
            <input
              ...
              focus:outline-none focus:border-amber-900 touch-action: none"
            />
          ...
          <div className="flex flex-col mb-2 font-playfair">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50 focus:outline-none focus:border-amber-900 touch-action: none"
            />
          </div>
